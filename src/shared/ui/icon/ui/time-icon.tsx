...
const TimeSvg = () => {
  return (
    ...
    >
      <g clipPath='url(#clip0_4142_18531)'>
        <path
...
export const TimeIcon: FC<Partial<CustomIconComponentProps>> = (props) => {
  return <Icon component={TimeSvg} {...props} />
}
