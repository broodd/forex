...
import cls from './days-table.module.scss'

interface IDaysTableProps {
  className?: string
}

export const DaysTable: FC<IDaysTableProps> = ({ className }) => {
  ...
  return (
    <>
      {lessons.length > 0 ? (
        ...
        <PageEmpty text={t('PAGES.DAYS.EMPTY')} render={!isLoading} />
      )}
    </>
  )
}
