...
export const QuestionsFormList: FC<IQuestionsFormListProps> = ({ className, initialValues }) => {
  const { t } = useTranslation()
  return (
    <div className={classNames(cls.wrapper, [className])}>
      <Form.List name='questions' initialValue={initialValues.questions}>
          ...
          <div>
            {questionFields.map(({ key: questionKey, name: questionName }) => (
              <React.Fragment key={questionKey}>
                ...
                <Flex vertical>
                  <Form.Item hidden name={[questionName, 'id']} />
                  <Form.Item
